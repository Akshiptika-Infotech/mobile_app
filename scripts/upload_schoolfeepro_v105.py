...
APK = "build/app/outputs/flutter-apk/app-schoolfeepro-release.apk"

print(f"Uploading SchoolFeePro v1.0.5")
print(f"APK: {APK}")
...
conn.request("POST", "/devtools/apk/upgrade/in.schoolfeepro.mobile_app", body=body, headers={
